    ...
    navbarPage(theme = shinytheme("flatly"), collapsible = TRUE,
               ...
               tabPanel("Overview",
                        column(
                          ...
                          p("There are wide disparities in public health access and infectious disease risk among
                            ...
                            mortality in both annual influenza and pandemic influenza(Hutchins). This increased 
                            ...
                            economic effects of pandemic policy(Blumenshine). Policy makers must account for these 
                          ...
                          p("The relationship between socioeconomic status and infectious disease has not been explored
                            ...
                            is associated with antibody level, but on a pathogen dependent basis(Hoes). "),
                          br(),
                          p("With the Covid-19 and Demographic Data Dashboard, the user will be able to explore simple linear 
                            ...
                            clustering option to explore hot and cold spots. This dashboard will be different in that it will 
                            be exploring relationships between COVID-19 cases and an assortment of demographic and socioeconomic
                            variables. The application will not prove relationships between COVID-19 and other variables, but will 
                            provide exploratory insight through visual analysis and other exploratory techniques. "),
                          br(),
                          h2("Methodology"),
                          p("The final product will be a shiny application that does exploratory mapping of different types of
                            COVID-19 cases, demographic variables, and socioeconomic indicators. Both of the maps will be of 
                            the United States at the county level. One map will focus on COVID-19 case types and population 
                            based rates. The other map will visualize demographic and socioeconomic variables. The maps will
                            be placed adjacently to allow for visual comparison of spatial trends. Below the two maps will be
                            some exploratory plots of both selected variables. One will be a scatterplot with the COVID-19 variable 
                            on the y-axis and the demographic or socioeconomic variable on the x axis. Both of these variables
                            will have a histogram adjacent to their map. I will add some additional summary statistics to accompany
                            these plots too. The bulk of the work for the application will be in creating processes to aggregate
                            and visualize the COVID-19 data for the selected date and case type. The demographic and socioeconomic 
                            data will be simpler to process, but will require significant work in gathering the desired variables 
                            from the American Community Survey and putting them together into one cohesive dataset for the application. 
                            The socioeconomic and demographic variables will include income, age distributions, race, demographics, 
                            and gender. "),
                          br(),
               ...
               tabPanel("Background",
                        ...
                        p("Disparities in public health and infectious disease risk are widespread among minority
                          ...
                          in both annual influenza and pandemic influenza(Hutchins). This increased risk stems from a
                          ...
                          Occupational differences lead to different levels of exposure to infectious diseases(Blumenshine).
                          ...
                          protection for vulnerable groups in the response(Hutchins). Measuring the disparities in risk and 
                        ...
                        p("The reduction of socioeconomic and racial disparities in health and healthcare has been a goal of 
                          ...
                          in healthcare, a pandemic is likely to disproportionately affect disadvantaged groups(Blumenshine). 
                          Strategic planning must consider differing life circumstances, cultural values, and perspectives on risk
                          guide behavior in a pandemic(Vaughan and Tinker). Minority groups have lower capacity to participate in
                          pandemic interventions and to endure a pandemic because of disparities caused by socioeconomic disadvantages,
                          cultural, educational, linguistic barriers, and lack of access to health care(Hutchins). Widespread 
                          ...
                          implications of the policy than other groups(Blumenshine). To create an effective and equitable pandemic
                        ...
                        p("The role of socioeconomic status and disparities in health access can be assessed with many different methods.
                          ...
                          pathogen. For example pneumoccus has a negative relationship with SES, while measles has a positive one.(Hoes). The 
                          ...
                          rates(Chowell and Viboud). This empirical study is the most relevant to the project data dashboard in topic,
                        ...
                        p("The methodological focus will be on spatial approaches in assessing and exploring the role of demographics 
                          ...
                          vary across space(Beale). This approach allows the researcher to rapidly communicate patterns and information 
                          ...
                          the on the approach taken(Elliot and Wartenburg). "),
                        br(),
                        p("A data dashboard can useful for the exploration and analysis of infectious diseases. In the case of COVID-19, there
                          ...
                          interpretable, and not hidden in a myriad plots and unnecessary information (Pappas). While disease mapping contains
                        ...
                        br(),
                        p("The application for this project will differ from existing applications in a few key aspects. The main difference
                          will be the cross comparison of COVID-19 case variables and other relevant socioeconomic and demographic variables. 
                          The COVID-19 variables will include the county based counts, population based rates, and relative risk rates. The
                          demographic variables will include percent composition of different minorities groups, education, crowding, and 
                          other relevant variables I can pull from the US Census website. The socioeconomic variables will include per capita
                          income and unemployment rates. The application will contain two maps, one for COVID-19 variables, and the other for 
                          socioeconomic and demographic variables. The two selected variables will output a scatterplot and associated
                          histograms for each variable. Both maps will be interactive, and provide variable information on the county hovered 
                          over by the mouse. The application will be done python will plotly to attain the more aesthetic maps and visualizations.")
               ...
               tabPanel("Data and Methodology",
                        ...
                        p("The data for this application focuses on COVID-19 data and a variety of demographic 
                          ...
                          will contain a folder of COVID-19 data by date. The dates range from the beginning of March 
                        ...
                        br(),
                        p("Most of the data workflow is in creating the final shapefile with all of the demographic
                          ...
                          descriptive. There was minimal computation in creating the final demographic and 
                          socioeconomic dataset. When downloaded, most of the demographic variables were
                        ...
                        br(),
                        p("The COVID-19 data will not need any editing for the application. The user will select a 
                          ...
                          of each COVID-19 variable will be computed. The user can then select a COVID-19 variable to map
                          and visualize. This is the basic data flow for the COVID-19 data. The demographic and
                          socioeconomic variables will not need any adjustments after they are loaded into the environment.
                          For a comprehensive visualization of the data flow with the date selection and variable 
                          selection widgets see figure 1."),
                        br(),
                        p("The application will have a simple layout with both maps and statistical visualizations.
                          ...
                          different variables. "),
                        br(),
                        p("The application will be made with leaflet and plotly visualizations in shiny. The
                          ...
                          the application will have hover interactivity, displaying the name of the county and 
                          values of the selected variable for the county hovered over with the mouse. The
                          scatterplot will also have this type of interactivity, but it will display the selected
                          x and y variable values of a hovered over observation. The visualizations included will 
                          be two choropleth maps, two histograms, and one scatterplot. These will be packaged
